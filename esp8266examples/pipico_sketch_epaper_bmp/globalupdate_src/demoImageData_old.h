...
#include "image_data/image_420_400x300_BW.c"
#define BW_martenBuffer (uint8_t *)&image_420_400x300_marten_BW_mono
#define BW_rolpiggyBuffer (uint8_t *)&image_420_400x300_rolpiggy_BW_mono
