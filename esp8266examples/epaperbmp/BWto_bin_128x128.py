...
ospath = "G:/temp/epaperbmp/128"
c_file = open("icons128x128.c", "w")
h_file = open("hfile_names128.txt", "w")
...
#{
    ...
    c_file.write("unsigned char image_128x128_" + fn_pre[0] + "_BW_mono[128][128]=\n")
